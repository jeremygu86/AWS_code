...
register /usr/hdp/2.3.2.0-2950/pig/piggybank.jar;
-- register /home/cloudera/incubator-datafu/datafu-pig/build/libs/datafu-pig-incubating-1.3.0-SNAPSHOT.jar;
register /home/ec2-user/apache-datafu-incubating-sources-1.3.0/datafu-pig/build/libs/datafu-pig-incubating-1.3.0.jar；
...
Y      = LOAD '/home/ec2-user/yelp_data/out2/index_data.csv' USING CSVLoader() AS(business_id:chararray,cool,date,funny,id,stars:int,text:chararray,type,useful:int,user_id,name,full_address,latitude,longitude,neighborhoods,open,review_count,state);
...
Y_rate2_o = ORDER BY Y_rate2 DESC;
-- 4 Rank businesses
